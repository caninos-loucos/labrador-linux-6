...
static unsigned int
pll_get_table_val(const struct clk_pll_table *table, unsigned long rate)
{
...
pll_get_table_round_rate(const struct clk_pll_table *table, unsigned long rate)
{
	const struct clk_pll_table *clkt;
	unsigned long best_rate = 0;
...
static unsigned int
pll_get_table_rate(const struct clk_pll_table *table, unsigned int val)
{
	const struct clk_pll_table *clkt;
...
static long
caninos_pll_round_rate(struct clk_hw *hw, unsigned long rate,
...
static int
caninos_pll_set_rate(struct clk_hw *hw, unsigned long rate,
                     unsigned long parent_rate)
{
	struct caninos_pll *pll = to_caninos_pll(hw);
	unsigned long flags;
...
static unsigned long
caninos_pll_recalc_rate(struct clk_hw *hw, unsigned long parent_rate)
{
	return pll_get_rate(hw);
}

static long
caninos_pll_ro_round_rate(struct clk_hw *hw, unsigned long rate,
                          unsigned long *parent_rate)
{
	return pll_get_rate(hw);
}
