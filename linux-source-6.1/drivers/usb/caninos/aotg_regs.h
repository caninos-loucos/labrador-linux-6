...
/******************************************************************************/
static inline void usb_setb(u8 val, volatile void __iomem *reg)
{
	writeb(readb(reg) | val, reg);
}

static inline void usb_setw(u16 val, volatile void __iomem *reg)
{
	writew(readw(reg) | val, reg);
}

static inline void usb_setl(u32 val, volatile void __iomem *reg)
{
	writel(readl(reg) | val, reg);
}

/******************************************************************************/
static inline void usb_clearb(u8 val, volatile void __iomem *reg)
{
	writeb(readb(reg)&(~val), reg);
}

static inline void usb_clearw(u16 val, volatile void __iomem *reg)
{
	writew(readw(reg)&(~val), reg);
}

static inline void usb_clearl(u32 val, volatile void __iomem *reg)
{
	writel(readl(reg)&(~val), reg);
}
